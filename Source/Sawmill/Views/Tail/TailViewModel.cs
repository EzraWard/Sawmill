...
using Sawmill.Views.DialogServices;
using Sawmill.Views.Searching;
...
public class TailViewModel: AbstractNotifyPropertyChanged, ILinesVisualisation, IPersistentView, IDialogViewModel, IPageProvider, ISelectedAware
{
        ...
        [NotNull] IDialogCoordinator dialogCoordinator)
    {
        ...
        OpenFileCommand = new Command(() => OpenPathInShell(fileWatcher.FullName));
        OpenFolderCommand = new Command(() => OpenPathInShell(fileWatcher.Folder));
